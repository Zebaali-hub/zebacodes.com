...
import { ArrowDownRight, ArrowUpRight, Code2, FileText, Mail } from 'lucide-react'
...
export function Hero() {
  return <section className="hero-v2" id="top"><div className="hero-ghost" aria-hidden="true">engineer</div><div className="hero-grid site-container">
    <div className="hero-copy">
      ...
      <div className="hero-actions"><Link href="#systems" className="button button-primary">Explore my systems <ArrowDownRight size={17} /></Link><a href="https://github.com/Zebaali-hub" target="_blank" rel="noreferrer" className="button button-secondary"><Code2 size={17} /> GitHub <ArrowUpRight size={14} /></a><a href="/Zeba_Ali_resume_.pdf" target="_blank" className="text-link"><FileText size={15} /> Resume</a><a href="mailto:zebaali1415@gmail.com" className="text-link"><Mail size={15} /> Contact</a></div>
    </div>
